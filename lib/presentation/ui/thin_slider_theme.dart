...
class ThinTrackShape extends RoundedRectSliderTrackShape {
  @override
...
class ThinThumbShape extends RoundSliderThumbShape {
  ThinThumbShape({super.enabledThumbRadius = 10.0});
